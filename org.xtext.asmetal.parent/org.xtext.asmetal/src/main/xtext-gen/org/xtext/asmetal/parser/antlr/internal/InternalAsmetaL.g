				...
				(
					...
					lv_name_2_1=ruleextendedNameForAsm
					{
						...
						set(
							...
							"name",
							lv_name_2_1,
							"org.xtext.asmetal.AsmetaL.extendedNameForAsm");
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"name",
							lv_name_2_2,
							"org.xtext.asmetal.AsmetaL.STRING");
					}
				)
			)
		)
			...
			(
				...
				lv_headerSection_3_0=ruleHeader
				{
					...
					set(
						...
						"org.xtext.asmetal.AsmetaL.Header");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_bodySection_4_0=ruleBody
				{
					...
					set(
						...
						"bodySection",
						lv_bodySection_4_0,
						"org.xtext.asmetal.AsmetaL.Body");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_mainrule_6_0=ruleMacroDeclaration
					{
						...
						set(
							...
							"mainrule",
							lv_mainrule_6_0,
							"org.xtext.asmetal.AsmetaL.MacroDeclaration");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_initialState_7_0=ruleInitialization
					{
						...
						add(
							...
							"initialState",
							lv_initialState_7_0,
							"org.xtext.asmetal.AsmetaL.Initialization");
						afterParserOrEnumRuleCall();
					}
				)
			)*
			...
			(
				...
				lv_importClause_0_0=ruleImportClause
				{
					...
					add(
						...
						"importClause",
						lv_importClause_0_0,
						"org.xtext.asmetal.AsmetaL.ImportClause");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_exportClause_1_0=ruleExportClause
				{
					...
					set(
						...
						"exportClause",
						lv_exportClause_1_0,
						"org.xtext.asmetal.AsmetaL.ExportClause");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_signature_2_0=ruleSignature
				{
					...
					set(
						...
						"signature",
						lv_signature_2_0,
						"org.xtext.asmetal.AsmetaL.Signature");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_moduleName_1_1=ruleMOD_ID
					{
						...
						set(
							...
							"moduleName",
							lv_moduleName_1_1,
							"org.xtext.asmetal.AsmetaL.MOD_ID");
						afterParserOrEnumRuleCall();
					}
					    |
				...
				(
					...
					lv_importedList_3_0=ruleimportData
					{
						...
						add(
							...
							"importedList",
							lv_importedList_3_0,
							"org.xtext.asmetal.AsmetaL.importData");
						afterParserOrEnumRuleCall();
					}
				)
			)
		...
		(
			...
			lv_name_0_0=ruleextendedName
			{
				...
				set(
					...
					"name",
					lv_name_0_0,
					"org.xtext.asmetal.AsmetaL.extendedName");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_domain_3_0=ruleDomain
				{
					...
					add(
						...
						"domain",
						lv_domain_3_0,
						"org.xtext.asmetal.AsmetaL.Domain");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_function_4_0=ruleFunction
				{
					...
					add(
						...
						"function",
						lv_function_4_0,
						"org.xtext.asmetal.AsmetaL.Function");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_domainInitialization_3_0=ruleDomainInitialization
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.DomainInitialization");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_functionInitialization_4_0=ruleFunctionInitialization
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.FunctionInitialization");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_agentInitialization_5_0=ruleAgentInitialization
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.AgentInitialization");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_body_3_0=ruleTerm
				{
					...
					set(
						...
						"body",
						lv_body_3_0,
						"org.xtext.asmetal.AsmetaL.Term");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_inizializedFunctionName_1_0=ruleextendedNameForFunction
				{
					...
					set(
						...
						"org.xtext.asmetal.AsmetaL.extendedNameForFunction");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_variables_3_0=ruleID_VARIABLE
					{
						...
						add(
							...
							"variables",
							lv_variables_3_0,
							"org.xtext.asmetal.AsmetaL.ID_VARIABLE");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_domain_5_0=rulegetDomainByID
					{
						...
						add(
							...
							"domain",
							lv_domain_5_0,
							"org.xtext.asmetal.AsmetaL.getDomainByID");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_program_3_0=ruleMacroCallRule
				{
					...
					set(
						...
						"program",
						lv_program_3_0,
						"org.xtext.asmetal.AsmetaL.MacroCallRule");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_domainDefinition_3_0=ruleDomainDefinition
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.DomainDefinition");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_functionDefinition_4_0=ruleFunctionDefinition
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.FunctionDefinition");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_ruleDeclaration_5_0=ruleRuleDeclaration
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.RuleDeclaration");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_invariantConstraint_6_0=ruleInvariantConstraint
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.InvariantConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_fairnessConstraint_7_0=ruleFairnessConstraint
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.FairnessConstraint");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_property_8_0=ruleProperty
				{
					...
					add(
						...
						"property",
						lv_property_8_0,
						"org.xtext.asmetal.AsmetaL.Property");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"name",
						lv_name_2_0,
						"org.xtext.asmetal.AsmetaL.RULE_ID");
				}
			)
		)
		(
			...
			(
				...
				lv_ruleBody_15_0=ruleRule
				{
					...
					set(
						...
						"ruleBody",
						lv_ruleBody_15_0,
						"org.xtext.asmetal.AsmetaL.Rule");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_invar_list_3_0=ruleInvariantElement
				{
					...
					add(
						...
						"invar_list",
						lv_invar_list_3_0,
						"org.xtext.asmetal.AsmetaL.InvariantElement");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_element_5_0=ruleEnumElement
				{
					...
					add(
						...
						"element",
						lv_element_5_0,
						"org.xtext.asmetal.AsmetaL.EnumElement");
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.ENUM_ID");
			}
		)
	)
;
				...
				(
					...
					lv_right_3_0=ruleXorOrExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.XorOrExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleAndExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.AndExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleEqualityExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.EqualityExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleCompareExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.CompareExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleAdditiveExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.AdditiveExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleMultiplicativeExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.MultiplicativeExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=rulePowerExpression
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.PowerExpression");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleUnaryOperation
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"org.xtext.asmetal.AsmetaL.UnaryOperation");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_arguments_3_0=ruleTupleTerm
				{
					...
					set(
						...
						"arguments",
						lv_arguments_3_0,
						"org.xtext.asmetal.AsmetaL.TupleTerm");
					afterParserOrEnumRuleCall();
				}
			)
		)?
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.COMPLEX_NUMBER");
			}
		)
	)
;
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.NATNUMBER");
			}
		)
	)
;
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.CHAR_LITERAL");
			}
		)
	)
;
		...
		(
			...
			}
			{
				...
				setWithLastConsumed(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.STRING_LITERAL");
			}
		)
	)
;
		...
		(
			...
			lv_symbol_0_0=ruleRealNumberWithSign
			{
				...
				set(
					...
					"symbol",
					lv_symbol_0_0,
					"org.xtext.asmetal.AsmetaL.RealNumberWithSign");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"symbol",
						lv_symbol_0_1,
						"org.xtext.asmetal.AsmetaL.NUMBER_TOKEN");
				}
				    |
				{
				...
				lv_symbol_0_2=ruleNumberWithSign
				{
					...
					set(
						...
						"symbol",
						lv_symbol_0_2,
						"org.xtext.asmetal.AsmetaL.NumberWithSign");
					afterParserOrEnumRuleCall();
				}
			)
		)
							...
							(
								...
								lv_step_8_0=ruleConstantTerm
								{
									...
									set(
										...
										"step",
										lv_step_8_0,
										"org.xtext.asmetal.AsmetaL.ConstantTerm");
									afterParserOrEnumRuleCall();
								}
							)
						)
				...
				(
					...
					lv_start_term_2_0=ruleBasicTerm
					{
						...
						set(
							...
							"start_term",
							lv_start_term_2_0,
							"org.xtext.asmetal.AsmetaL.BasicTerm");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_variable_3_0=ruleVariableTerm
				{
					...
					add(
						...
						"variable",
						lv_variable_3_0,
						"org.xtext.asmetal.AsmetaL.VariableTerm");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_term_0_1=ruleFunctionTerm
					{
						...
						set(
							...
							"term",
							lv_term_0_1,
							"org.xtext.asmetal.AsmetaL.FunctionTerm");
						afterParserOrEnumRuleCall();
					}
					    |
					{
				...
				(
					...
					lv_location_0_1=ruleLocationTerm
					{
						...
						set(
							...
							"location",
							lv_location_0_1,
							"org.xtext.asmetal.AsmetaL.LocationTerm");
						afterParserOrEnumRuleCall();
					}
					    |
					{
			...
			(
				...
				lv_updateRule_2_0=ruleTurboCallRule
				{
					...
					set(
						...
						"updateRule",
						lv_updateRule_2_0,
						"org.xtext.asmetal.AsmetaL.TurboCallRule");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_localFunction_0_0=ruleLocalFunction
				{
					...
					add(
						...
						"org.xtext.asmetal.AsmetaL.LocalFunction");
					afterParserOrEnumRuleCall();
				}
			)
		)
